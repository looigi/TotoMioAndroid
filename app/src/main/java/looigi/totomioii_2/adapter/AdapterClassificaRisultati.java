...
public class AdapterClassificaRisultati extends ArrayAdapter
{
	private Context context;
	private List<String> lista;
	private int posi;

	public AdapterClassificaRisultati(Context context, int textViewResourceId, List<String> objects)
	{	
