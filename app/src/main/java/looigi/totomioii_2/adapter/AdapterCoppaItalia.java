...
public class AdapterCoppaItalia extends ArrayAdapter
{
	private Context context;
	private List<String> lista;

	public AdapterCoppaItalia(Context context, int textViewResourceId, List<String> objects)
	{	
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		//{
			...
			convertView = inflater.inflate(R.layout.lst_coppaitalia, null);
