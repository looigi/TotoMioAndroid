...
public class AdapterClassificaSpeciale extends ArrayAdapter
{
	private Context context;
	private List<String> lista;
	private int posi;

	public AdapterClassificaSpeciale(Context context, int textViewResourceId, List<String> objects)
	{	
