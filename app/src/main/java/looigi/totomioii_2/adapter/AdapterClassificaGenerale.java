...
public class AdapterClassificaGenerale extends ArrayAdapter
{
	private Context context;
	private List<String> lista;
	private int posi;

	public AdapterClassificaGenerale(Context context, int textViewResourceId, List<String> objects)
	{	
