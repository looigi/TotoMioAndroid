...
public class classifica_campionato {
    //-------- Singleton ----------//
    private static classifica_campionato instance = null;

    private classifica_campionato() {
    }

    public static classifica_campionato getInstance() {
        if (instance == null) {
            instance = new classifica_campionato();
        }
    ...
    public void VisualizzaClassificaGenerale(String Classifica) {
    ...
    public void VisualizzaClassificaCampionato(String Classifica) {
        List<String> lista = new ArrayList<>();
        String Campi[]=Classifica.split("§");
